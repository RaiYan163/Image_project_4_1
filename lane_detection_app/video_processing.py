...
class DashboardPage:
    def __init__(self, root, video_path, go_back_callback):
        ...
        self.speed_scale = Scale(self.frame, from_=0.1, to=2.0, resolution=0.1, orient=HORIZONTAL, label="Speed Control", length=300)
        self.speed_scale.set(2.0)  # Set initial value to the maximum speed
